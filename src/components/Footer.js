...
const Footer = () => {
    return <section className="bg-beige-300">
        <div className="responsive-container py-10 lg:py-0 lg:h-[100px] flex flex-col-reverse gap-5 lg:flex-row items-center justify-between text-[14px] text-center">

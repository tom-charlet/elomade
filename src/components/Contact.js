...
const Contact = () => {
    return <section id="me-contacter" className='bg-red-800 py-16 lg:py-[120px] overflow-hidden'>
        <div className='responsive-container grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-32 text-beige-300'>
            <Animation type={["move", "fade"]} stagger={0.1} direction="right" once mobileUp amount={0.2} className='flex flex-col items-start'>
                ...
                <div className='flex flex-col md:flex-row md:items-center gap-6'>
                    <div className='flex items-center gap-3'>
                        <Button href="https://www.tiktok.com/@elomadecrochet" target="_blank" icon="tiktok" variante="fill-beige" />
                        <Button href="https://www.instagram.com/elomadecrochet" target="_blank" icon="instagram" variante="fill-beige" />
                    </div>
                    <Button icon="email" variante="stroke-beige">elomade@elomade.fr</Button>
                </div>
            </Animation>
            <Animation type={["move", "fade"]} direction="left" once amount={0.2} mobileUp className='aspect-[16/12] sm:aspect-[16/10] w-full bg-beige-300 rounded-2xl overflow-hidden'>
